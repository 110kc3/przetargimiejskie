...
(function () {
  ...
  const STRINGS = {
    en: {
      // popup
      'popup.title': 'przetargimiejskie — auction history',
      ...
      'dealscore.below': 'below median',
      'dealscore.above': 'above median',
      'dealscore.tooltip': 'City median ${median} zł/m² (${n} flats)',
      ...
      'popup.watching.active_prior': '(${n}×, ${unsold} unsold)',
    ...
    pl: {
      // popup
      'popup.title': 'przetargimiejskie — historia aukcji',
      ...
      'dealscore.below': 'poniżej mediany',
      'dealscore.above': 'powyżej mediany',
      'dealscore.tooltip': 'Mediana miasta ${median} zł/m² (${n} mieszk.)',
      'popup.col.status': 'Status',
      ...
      'popup.watching.active_prior': '(${n}×, ${unsold} bez sprzedaży)',
